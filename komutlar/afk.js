...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
    ...
    await db.set(
      ...
      "Şu an AFK olabilirim... Ama döneceğim !"
    );
    await db.set(
   ...
   message.channel.send(new MessageEmbed().setColor('BLACK').setDescription(`${kullanıcı} Başarıyla AFK moduna geçtin ve mesajını şu şekilde ayarladım \n**${ramo}**`));
